					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update products set rs_id='$_POST[res_name]',title='$_POST[d_name]',description='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
